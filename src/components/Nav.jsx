...
<div className="border border-white flex flex-row  my-0 mx-auto flex-wrap  flex flex-wrap flex-row gap-10">
...
<div className="w-fit mb-2 mt-2 mx-auto px-2 border border-white h-fit flex flex-row flex-wrap gap-8">
      <i title="React js" className='w-fit my-0 mx-auto px-2 rounded-lg h-fit border border-white'>
      <BiCodeAlt size={30}/>
  </i>

      <i title="React TypeScript" className='border border-white w-fit my-0 mx-auto px-2 rounded-lg h-fit '>
   <BiCodeAlt size={30}/>
  </i>

      <i title="JavaScript" className='border border-white w-fit my-0 mx-auto px-2 rounded-lg h-fit '>
   <BiCodeAlt size={30}/>
  </i>

      <i title="HTML" className='border border-white w-fit my-0 mx-auto px-2 rounded-lg h-fit '>
   <BiCodeAlt size={30}/>
  </i>

      <i title="CSS" className='border border-white w-fit my-0 mx-auto px-2 rounded-lg h-fit '>
    <BiCodeAlt size={30}/>
  </i>
</div>
</div>
